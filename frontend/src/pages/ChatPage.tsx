    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100vh", background: "#f8fafc" }}>
      ...
      <div style={{ padding: "1rem 1.5rem", background: "#fff", borderBottom: "1px solid #f3f4f6", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12, boxShadow: "0 1px 4px rgba(0,0,0,0.04)" }}>
        ...
        {hasExchange && !streaming && (
          <button onClick={onRegenerate}
            style={{ padding: "7px 14px", borderRadius: 10, border: "1px solid #e5e7eb", background: "#fff", color: "#374151", fontSize: "0.82rem", fontWeight: 600, cursor: "pointer", fontFamily: "inherit", display: "flex", alignItems: "center", gap: 5 }}>
        ...
        {messages.length === 0 && (
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", flex: 1, gap: 16, padding: "3rem 1rem" }}>
            <div style={{ width: 72, height: 72, borderRadius: 22, background: "linear-gradient(135deg, #f97316, #ec4899)", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 8px 24px rgba(249,115,22,0.3)" }}>
              <svg width="34" height="34" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></svg>
            </div>
              ...
              {msg.content ? (
                msg.role === "user" ? (
                  ...
                  <ReactMarkdown components={{
                    ...
                    h3: ({ children }) => <h3 style={{ fontSize: "0.92rem", fontWeight: 700, margin: "0.5rem 0 0.25rem", color: "#111827" }}>{children}</h3>,
                    ...
                    pre: ({ children }) => <pre style={{ background: "#f8fafc", border: "1px solid #e5e7eb", padding: "0.75rem 1rem", borderRadius: 10, overflowX: "auto", fontSize: "0.85rem", margin: "0.5rem 0" }}>{children}</pre>,
      ...
      <div style={{ padding: "1rem 1.5rem", background: "#fff", borderTop: "1px solid #f3f4f6" }}>
        <form onSubmit={handleSubmit}
          style={{ display: "flex", alignItems: "flex-end", gap: 10, background: "#f8fafc", borderRadius: 20, border: "1.5px solid #e5e7eb", padding: "8px 8px 8px 16px", transition: "border-color 0.15s" }}
          onFocus={() => {}} >
          <textarea
